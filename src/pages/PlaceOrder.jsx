    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          ...
          <input type='email' placeholder='E-mail addresss' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
          <input type='text' placeholder='Street Name' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
          <div className='flex gap-3'>
          <input type='text' placeholder='Region' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
      ...
      {/* ----- Payment Method Selection ---- */}
        <div className='flex gap-3 flex-col lg:flex-row'>
          <div onClick={()=>setMethod('visa')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
            ...
            <img src={assets.stripe_logo} className='h-5 mx-4 w-full' alt="" />
          </div>
          ...
          <div  onClick={()=>setMethod('cod')}className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
            ...
            <p className='text-gray-600 text-sm font-medium mx-4'>IN CASH</p>
          </div>
        </div>
        <div className='w-full text-end mt-8'>
          <button onClick={()=>navigate('/orders')} className='bg-black text-white px-16 py-3 text-sm active:bg-white active:text-black cursor-pointer'>PLACE YOUR ORDER</button>
        </div>
      </div>
      </div>
