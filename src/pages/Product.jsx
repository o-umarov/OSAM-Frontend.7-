...
const Product = () => {
  ...
  return productData ?  (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
          <div className='flex'>
                <b className='border px-16 py-3 text-sm mr-5'>DESCRIPTION</b>
                <p className='border px-10 py-3 text-sm'>REVIEWS (103)</p>
          </div>
          <div className='flex flex-col gap-4 px-6 py-6 text-sm text-gray-500'>
                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque iste similique perspiciatis aliquid odit earum, veniam ut alias, consequatur officiis deserunt laborum quia, est cupiditate saepe quod ea sapiente dolorem.</p>
